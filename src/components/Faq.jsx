...
const Faq = () => {
    ...
    return (
        ...
        >
            <h2 className={`text-2xl lg:text-4xl mb-8 lg:mb-12 font-bold text-center`}>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
               ...
               <div className=' h-[300px] lg:h-[400px]'>
                ...
                <div className=''>
                    <div
                        className={`collapse collapse-arrow my-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-600'}`}
                    >
                        <input type="radio" name="faq-accordion" defaultChecked />
                        <div className="collapse-title text-xl font-medium">How can I create an assignment?</div>
                        <div className="collapse-content">
                            <p className='font-bold text-[#0AB99D]'>Go to Create Assignment, fill in details, and click Submit.</p>
                        </div>
                    </div>
                    <div
                        className={`collapse collapse-arrow my-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-600'}`}
                    >
                        ...
                        <div className="collapse-content">
                            <p className='font-bold text-[#0AB99D]'>Select the assignment, upload your work, and click Submit.</p>
                        </div>
                    </div>
                    <div
                        className={`collapse collapse-arrow my-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-600'}`}
                    >
                        ...
                        <div className="collapse-content">
                            <p className='font-bold text-[#0AB99D]'>Friends can grade submissions, and the average grade is auto-calculated.</p>
                        </div>
                    </div>
                    <div
                        className={`collapse collapse-arrow my-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-600'}`}
                    >
                        ...
                        <div className="collapse-content">
                            <p className='font-bold text-[#0AB99D]'>Yes, you can edit it before the due date.</p>
                        </div>
                    </div>
                    <div
                        className={`collapse collapse-arrow my-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-600'}`}
                    >
                        ...
                        <div className="collapse-content">
                            <p className='font-bold text-[#0AB99D]'>No, you can create unlimited assignments.</p>
                        </div>
                    </div>
                </div>
            </div>
