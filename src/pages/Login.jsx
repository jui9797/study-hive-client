            ...
            <div className="hero min-h-screen my-10 rounded-lg lg:px-6">
                <div className="hero-content flex-col lg:flex-row">
                    <div className="text-center lg:text-left">
                       ...
                       <div>
                        <Lottie animationData={loginImg} style={{ width: '100%', height: '350px', backgroundColor:'white' }}></Lottie>
                       </div>
                    ...
                    <div className="card bg-base-100 bg-opacity-50 w-full max-w-sm shrink-0 shadow-2xl">
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <button className='btn border-none text-white ml-2 bg-[#0AB99D]'>Login</button>
                            </div>
                        </form>
                        <p className='ml-2 text-gray-700'>  New to this website? Please<Link to='/register' className='text-[#071d19] font-bold ml-2'>Register</Link></p>
