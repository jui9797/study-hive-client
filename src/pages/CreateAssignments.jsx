...
const CreateAssignments = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://assignment-11-server-mu-five.vercel.app/assignments",
        assignment
      )
      .then((res) => {
        Swal.fire({
  ...
  return (
    <div className="my-10 px-4 lg:px-6">
      <div
        className={`assignment-form-container rounded-lg  p-4 ${
          isDarkMode ? "bg-gray-800 text-white" : "bg-green-50 text-gray-700"
        }`}
      >
        <h2 className="text-lg font-bold mb-4 mt-10">
          Create Assignment For Others.
        </h2>
